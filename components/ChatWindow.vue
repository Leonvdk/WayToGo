...
import gpt from '@/server/api/gpt';

const content = ref('');
const res = ref('✅ The answer will be displayed here.');

const askGpt = () => {
  gpt.post('/completions', {
    model: 'gpt-4',
  ...
  <div>
    ...
    <div class="chat">
      ...
      <div class="button-block">
        <button type="button" @click="askGpt" class="btn">
          <strong> send </strong>
...
.btn {
  ...
  background-image: linear-gradient(#212121, #212121),  linear-gradient
  (137.48deg, #ffdb3b 10%,#FE53BB 45%, #8F51EA 67%, #0044ff 87%);
