globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///Users/leonvandeklundert/Leonvdk/Projects/WayToGo/node_modules/node-fetch-native/dist/polyfill.mjs';
...
import { renderToString } from 'file:///Users/leonvandeklundert/Leonvdk/Projects/WayToGo/node_modules/vue/server-renderer/index.mjs';
import { parseURL, withQuery, joinURL } from 'file:///Users/leonvandeklundert/Leonvdk/Projects/WayToGo/node_modules/ufo/dist/index.mjs';
import destr from 'file:///Users/leonvandeklundert/Leonvdk/Projects/WayToGo/node_modules/destr/dist/index.mjs';
import { snakeCase } from 'file:///Users/leonvandeklundert/Leonvdk/Projects/WayToGo/node_modules/scule/dist/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file:///Users/leonvandeklundert/Leonvdk/Projects/WayToGo/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Users/leonvandeklundert/Leonvdk/Projects/WayToGo/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/leonvandeklundert/Leonvdk/Projects/WayToGo/node_modules/hookable/dist/index.mjs';
import { hash } from 'file:///Users/leonvandeklundert/Leonvdk/Projects/WayToGo/node_modules/ohash/dist/index.mjs';
import { createStorage } from 'file:///Users/leonvandeklundert/Leonvdk/Projects/WayToGo/node_modules/unstorage/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/leonvandeklundert/Leonvdk/Projects/WayToGo/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/leonvandeklundert/Leonvdk/Projects/WayToGo","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/leonvandeklundert/Leonvdk/Projects/WayToGo/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/leonvandeklundert/Leonvdk/Projects/WayToGo/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/leonvandeklundert/Leonvdk/Projects/WayToGo/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const errorHandler = (async function errorhandler(error, event) {
  ...
  if (!res) {
    const { template } = await import('file:///Users/leonvandeklundert/Leonvdk/Projects/WayToGo/node_modules/@nuxt/ui-templates/dist/templates/error-dev.mjs') ;
    {
...
const APIKEY = globalThis._importMeta_.env.VITE_OPEN_AI_API_KEY;
const ORG_ID = globalThis._importMeta_.env.VITE_OPEN_AI_ORG_ID;
...
const gpt$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  'default': gpt
});
...
const getClientManifest = () => import('/Users/leonvandeklundert/Leonvdk/Projects/WayToGo/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('/Users/leonvandeklundert/Leonvdk/Projects/WayToGo/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
